...
// |                                                                  |
// ====================================================================
// ================== ComboOracle_UniV2_UniV3_Zenlink =================
// ====================================================================
...
// Zenlink (UniV2 / SLP analogue)
import "../Misc_AMOs/zenlink/IZenlinkPair.sol";
import "../Misc_AMOs/zenlink/IZenlinkRouter.sol";
...
contract ComboOracle_UniV2_UniV3_Zenlink is Owned {
    ...
    constructor (
        ...
        // UniV2 / SLP
        router = IZenlinkRouter(_starting_addresses[3]);
    ...
    function uniV2LPBasicInfo(address pair_address) public view returns (UniV2LPBasicInfo memory) {
        ...
        IZenlinkPair the_pair = IZenlinkPair(pair_address);
