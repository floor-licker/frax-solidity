...
contract StakingRewardsDualV4 is Owned, ReentrancyGuard {
    ...
    function _getReward(address rewardee, address destination_address) internal nonReentrant updateRewardAndBalance(rewardee, true) returns (uint256 reward0, uint256 reward1) {
